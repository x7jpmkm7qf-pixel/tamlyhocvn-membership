    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="flex gap-2 mb-6">
          ...
          <button onClick={() => setTab('affiliate')} className={`px-4 py-2 rounded-xl text-sm font-medium transition flex items-center gap-2 ${tab === 'affiliate' ? 'bg-violet-600 text-white' : 'bg-white text-slate-600 border border-slate-200 hover:border-violet-400'}`}>
            💰 Affiliate
            {affPendingCount > 0 && (
              <span className="bg-rose-500 text-white text-xs font-black px-1.5 py-0.5 rounded-full">
                {affPendingCount}
        ...
        {/* Affiliate tab */}
        {tab === 'affiliate' && (
          <AffiliateTab onPendingCountChange={setAffPendingCount} />
        )}
